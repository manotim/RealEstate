"""Updated User role with Enum3

Revision ID: a73a029e5041
Revises: 
Create Date: 2025-03-27 21:22:42.745952
...
def upgrade():
    ...
    sa.Column('role', postgresql.ENUM('tenant', 'landlord', 'admin', name='user_role'), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['tenant_id'], ['tenant.id'], ),
    sa.ForeignKeyConstraint(['water_bill_id'], ['water_bill.id'], ),
    sa.PrimaryKeyConstraint('id'),
